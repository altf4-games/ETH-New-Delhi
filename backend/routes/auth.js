...
router.get("/strava/callback", async (req, res) => {
  ...
  try {
    ...
    const { access_token, refresh_token, expires_at, expires_in, athlete } =
      tokenResponse.data;
...
router.get("/status", (req, res) => {
  res.json({
    authenticated: false,
    message:
      "FitConquer uses wallet-based authentication. Connect your MetaMask wallet to authenticate.",
